...
exports.sendDueDateReminder = exports.sendVerificationEmail = exports.transporter = void 0;
...
const sendDueDateReminder = (email, bookTitle, dueDate) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield exports.transporter.sendMail({
            from: process.env.SMTP_USER,
            to: email,
