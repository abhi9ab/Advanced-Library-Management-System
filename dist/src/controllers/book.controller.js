...
exports.restoreController = exports.softDeleteController = exports.getByIdController = exports.updateController = exports.searchController = exports.createController = void 0;
...
const updateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const validatedData = validators_1.bookSchema.parse(req.body);
        const book = yield (0, book_service_1.update)(id, validatedData);
        res.json(book);
    }
    catch (error) {
...
const getByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const book = yield (0, book_service_1.getById)(id);
        if (!book) {
